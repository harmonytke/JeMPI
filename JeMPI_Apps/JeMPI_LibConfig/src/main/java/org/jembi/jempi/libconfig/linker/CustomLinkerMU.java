...
public final class CustomLinkerMU {
   ...
   void updateMatchSums(
      ...
      updateMatchedPair(fields.givenName, patient.fields[GIVEN_NAME_IDX].value(), goldenRecord.fields[GIVEN_NAME_IDX].value());
      updateMatchedPair(fields.familyName, patient.fields[FAMILY_NAME_IDX].value(), goldenRecord.fields[FAMILY_NAME_IDX].value());
      updateMatchedPair(fields.gender, patient.fields[GENDER_IDX].value(), goldenRecord.fields[GENDER_IDX].value());
      updateMatchedPair(fields.dob, patient.fields[DOB_IDX].value(), goldenRecord.fields[DOB_IDX].value());
      updateMatchedPair(fields.city, patient.fields[CITY_IDX].value(), goldenRecord.fields[CITY_IDX].value());
      updateMatchedPair(fields.phoneNumber, patient.fields[PHONE_NUMBER_IDX].value(), goldenRecord.fields[PHONE_NUMBER_IDX].value());
      updateMatchedPair(fields.nationalId, patient.fields[NATIONAL_ID_IDX].value(), goldenRecord.fields[NATIONAL_ID_IDX].value());
      LOGGER.debug("{}", fields);
   }
   ...
   void updateMissmatchSums(
         final CustomDemographicData patient,
         final CustomDemographicData goldenRecord) {
      updateUnMatchedPair(fields.givenName, patient.fields[GIVEN_NAME_IDX].value(), goldenRecord.fields[GIVEN_NAME_IDX].value());
      updateUnMatchedPair(fields.familyName, patient.fields[FAMILY_NAME_IDX].value(), goldenRecord.fields[FAMILY_NAME_IDX].value());
      updateUnMatchedPair(fields.gender, patient.fields[GENDER_IDX].value(), goldenRecord.fields[GENDER_IDX].value());
      updateUnMatchedPair(fields.dob, patient.fields[DOB_IDX].value(), goldenRecord.fields[DOB_IDX].value());
      updateUnMatchedPair(fields.city, patient.fields[CITY_IDX].value(), goldenRecord.fields[CITY_IDX].value());
      updateUnMatchedPair(fields.phoneNumber, patient.fields[PHONE_NUMBER_IDX].value(), goldenRecord.fields[PHONE_NUMBER_IDX].value());
      updateUnMatchedPair(fields.nationalId, patient.fields[NATIONAL_ID_IDX].value(), goldenRecord.fields[NATIONAL_ID_IDX].value());
      LOGGER.debug("{}", fields);
   }
