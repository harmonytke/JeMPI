...
public final class CustomDgraphConstants {
   ...
   public static final String GOLDEN_RECORD_FIELD_NAMES =
         """
         uid
   ...
   public static final String EXPANDED_GOLDEN_RECORD_FIELD_NAMES =
         """
         uid
         GoldenRecord.source_id {
            uid
         ...
         """;
   public static final String INTERACTION_FIELD_NAMES =
         """
         uid
         Interaction.source_id {
            uid
         ...
         Interaction.national_id
         """;
   public static final String QUERY_GET_INTERACTION_BY_UID =
         """
         ...
         """;
   public static final String QUERY_GET_GOLDEN_RECORD_BY_UID =
         """
         ...
         """;
   public static final String QUERY_GET_EXPANDED_INTERACTIONS =
         """
         ...
         """;
   public static final String QUERY_GET_GOLDEN_RECORDS =
         """
         query goldenRecord() {
            all(func: uid(%s)) {
               uid
         ...
         """;
   public static final String QUERY_GET_EXPANDED_GOLDEN_RECORDS =
         """
         ...
         """;
   public static final String MUTATION_CREATE_SOURCE_ID_TYPE =
         """
         type SourceId {
            SourceId.facility
            SourceId.patient
         ...
         """;
   public static final String MUTATION_CREATE_SOURCE_ID_FIELDS =
         """
         SourceId.facility:                     string    @index(exact)                      .
         SourceId.patient:                      string    @index(exact)                      .
         """;
   public static final String MUTATION_CREATE_GOLDEN_RECORD_TYPE =
         """
         ...
         """;
   public static final String MUTATION_CREATE_GOLDEN_RECORD_FIELDS =
         """
         ...
         """;
   public static final String MUTATION_CREATE_INTERACTION_TYPE =
         """
         ...
         """;
   public static final String MUTATION_CREATE_INTERACTION_FIELDS =
         """
